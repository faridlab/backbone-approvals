//! Specifications for ApprovalStepTemplate aggregate
//!
...
// Each predicate implements `Specification<ApprovalStepTemplate>` and can be combined
...
//
// pub struct ActiveApprovalStepTemplateSpec;
// impl Specification<ApprovalStepTemplate> for ActiveApprovalStepTemplateSpec {
//     fn is_satisfied_by(&self, e: &ApprovalStepTemplate) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
