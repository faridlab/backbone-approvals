//! Specifications for Delegation aggregate
//!
...
// Each predicate implements `Specification<Delegation>` and can be combined
...
//
// pub struct ActiveDelegationSpec;
// impl Specification<Delegation> for ActiveDelegationSpec {
//     fn is_satisfied_by(&self, e: &Delegation) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
