//! Specifications for ApprovalPolicy aggregate
//!
...
// Each predicate implements `Specification<ApprovalPolicy>` and can be combined
...
//
// pub struct ActiveApprovalPolicySpec;
// impl Specification<ApprovalPolicy> for ActiveApprovalPolicySpec {
//     fn is_satisfied_by(&self, e: &ApprovalPolicy) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
